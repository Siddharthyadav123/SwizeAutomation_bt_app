...
public class Spinner extends FrameLayout {
    ...
    private void applyStyle(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
        ...
        mGravity = 17;//a.getInt(R.styleable.Spinner_android_gravity, Gravity.CENTER);
        ...
        mPopup.setPromptText(a.getString(/*R.styleable.Spinner_prompt*/7));
        ...
        mDisableChildrenWhenDisabled = a.getBoolean(/*R.styleable.Spinner_disableChildrenWhenDisabled*/10, false);
