...
public class MySwitch extends CompoundButton {
    ...
    public MySwitch(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTrackDrawable = a.getDrawable(R.styleable.MySwitch_track_x);
        ...
        mThumbTextPadding = a.getDimensionPixelSize(R.styleable.MySwitch_thumbTextPadding_x, (int) (5 * density));
        mTrackTextPadding = a.getDimensionPixelSize(R.styleable.MySwitch_trackTextPadding, (int) (5 * density));

        mSwitchMinWidth = a.getDimensionPixelSize(R.styleable.MySwitch_switchMinWidth_x, (int) (60 * density));
        mSwitchMinHeight = a.getDimensionPixelSize(R.styleable.MySwitch_switchMinHeight, 0);
        mSwitchPadding = a.getDimensionPixelSize(R.styleable.MySwitch_switchPadding_x, 0);
