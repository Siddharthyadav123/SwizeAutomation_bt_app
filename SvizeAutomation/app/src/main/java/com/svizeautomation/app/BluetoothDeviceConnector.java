...
public class BluetoothDeviceConnector implements DeviceConnector {
    ...
    private static final String TAG = BluetoothDeviceConnector.class
            .getSimpleName();
    ...
    public synchronized void connect() {
        BluetoothDevice device = getBluetoothAdapter()
    ...
    public void sendAsciiMessage(CharSequence chars) {
        write((chars.toString().trim()).getBytes());
    }
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device) throws SecurityException,
            ...
            try {
                // call hidden method, see BluetoothDevice source code for more
                // details:
